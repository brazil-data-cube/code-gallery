...
# Jupyter Notebooks - Services


## Data Access through SpatioTemporal Asset Catalog API ([STAC](https://stacspec.org/en))
...
## Web Time Series Service ([WTSS](https://data.inpe.br/bdc/wtss-web-time-series-service/))
...
## Web Land Trajectory Service ([WLTS](https://data.inpe.br/bdc/wlts-web-land-trajectory-service/))
...
## [BIG TechTalks](https://data.inpe.br/bigtechtalks/)

- [Processamento de Imagens GOES utilizando STAC e Python](https://github.com/brazil-data-cube/code-gallery/tree/master/jupyter/events/big-techtalks/02)

- [Acesso, Visualização e Processamento de Imagens Sentinel-2 utilizando Python - Spatio Temporal Asset Catalog (STAC)](https://github.com/brazil-data-cube/code-gallery/tree/master/jupyter/events/big-techtalks/03)

- [Sensoriamento Remoto aplicado ao estudo de ecossistemas de água doce](https://github.com/brazil-data-cube/code-gallery/tree/master/jupyter/events/big-techtalks/04)

- [Acesso e visualização de dados TOPODATA com Python e STAC](https://github.com/brazil-data-cube/code-gallery/tree/master/jupyter/events/big-techtalks/05)
...
## [Other Events](https://github.com/brazil-data-cube/code-gallery/tree/master/jupyter/events)
...
<details>
<summary><b>Share &amp; cite this article</b></summary>
...
@Article{Ferreira2020,
    ...
    number = {24},
    article-number = {4033},
    url = {https://www.mdpi.com/2072-4292/12/24/4033},
    issn = {2072-4292},

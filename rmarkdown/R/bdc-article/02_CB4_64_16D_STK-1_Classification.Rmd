...
# Land Use and Cover Mapping from CBERS-4/AWFI Data Cubes
...
```{r}
rst <- raster::raster(
    paste0(out_classification_directory, "/cube_to_classify_022024_probs_class_2018_8_2019_7_v1.tif")
)
...
# labels
saveRDS(
    labels, file = paste0(out_directory, "/labels.rds")
)

# probs
saveRDS(
    probs, file = paste0(out_directory, "/probs_cube.rds")
)

# smoothed probs
saveRDS(
    probs_smoothed, file = paste0(out_directory, "/probs_smoothed_cube.rds")
)
```
